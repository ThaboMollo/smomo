...
const inputCls = 'w-full rounded-xl border border-border bg-card px-3 py-2 text-sm';
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <Card className="space-y-3">
        <p className="font-semibold">Add a service</p>
        ...
        <button onClick={() => save.mutate()} disabled={title.trim().length < 2 || save.isPending} className="rounded-xl bg-primary px-4 py-2 text-sm font-semibold text-white disabled:opacity-50">
